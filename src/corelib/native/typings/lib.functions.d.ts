 ...
 */
declare interface CreateRuntimeErrorDelegation<TException extends Error> {
	/**
	 * 创建运行时异常的方法委托。
	 * @author Wang Yucai
	 *
 ...
 */
declare interface ParseNumericStringSuccessCallback {
	/**
	 * 数字字符串转换成功回调方法委托。
	 * @author Wang Yucai
	 *
 ...
 */
declare interface ParseNumericStringFailureCallback {
	/**
	 * 数字字符串转换失败回调方法委托。
	 * @author Wang Yucai
	 *
